...
{
    public class AankoopViewModel : FreshBasePageModel
    {
        ...
        public AankoopViewModel(IKlantenService klantenService, IVoertuigenService voertuigenService)
        {
        ...
        private DateTime aanbod;
        public DateTime Aanbod
        {
            get { return aanbod; }
            set
            {
        ...
        private void LoadAankoopPageState()
        {
            ...
            Bouwjaar = "2014";
            Prijs = "14000";
            //Aanbod = Convert.ToDateTime("01-jan-2000", CultureInfo.CurrentCulture);
            Aanbod = DateTime.Now;
        ...
        public ICommand BewaarAanKoopCommand => new Command(
            async () =>
            {
        ...
        public ICommand LocatieCommand => new Command(
           async () =>
           {
               
               await CoreMethods.PushPageModel<LocatieViewModel>(currentKlant, false, true);
