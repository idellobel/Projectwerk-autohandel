...
{
    [Area("Admin")]
    public class KoelvloeistofController : Controller
    {
        private readonly AutohandelContext _context;

        public KoelvloeistofController(AutohandelContext context)
        {
            _context = context;
        }

        // GET: Admin/Koelvloeistof
        [Route("Admin/Koelvloeistof/Index")]
        public async Task<IActionResult> Index()
        {
            var autohandelContext = _context.OnderdelenProducten
                                  ...
                                  .Where(o => o.CategorieOnderdelen.OnderdelenCategorienaam == "Koelvloeistof")
        ...
        // GET: Admin/Koelvloeistof/Details/5
        [Route("Admin/Koelvloeistof/Details/{id}")]
        ...
        // GET: Admin/Koelvloeistof/Create
        [Route("Admin/Koelvloeistof/Create")]
        public IActionResult Create()
        {
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Koelvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam");
            ViewData["LeveranciersLijst"] = new SelectList(_context.Leveranciers, "LeverancierID", "LeverancierNaam");

            return View();
        }

        // POST: Admin/Koelvloeistof/Create
        [Route("Admin/Koelvloeistof/Create")]
        ...
        public async Task<IActionResult> Create([Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenCreate)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"Koelvloeistof <b>{onderdelenProductenCreate.Artikelnummer}</b> werd toegevoegd!";
                return RedirectToAction(nameof(Index));
            }
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Koelvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenCreate.OnderdelenCategorieId);
        ...
        // GET: Admin/Koelvloeistof/Edit/5
        [Route("Admin/Koelvloeistof/Edit/{id}")]
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Koelvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProducten.OnderdelenCategorieId);
        ...
        // POST: Admin/Koelvloeistof/Edit/5
        [Route("Admin/Koelvloeistof/Edit/{id}")]
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenEdit)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["SuccessMessage"] = $"Koelvloeistof <b>{onderdelenProductenEdit.Artikelnummer}</b> werd gewijzigd!";
                    return RedirectToAction(nameof(Index));
                }
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Koelvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenEdit.OnderdelenCategorieId);
        ...
        // GET: Admin/Koelvloeistof/Delete/5
        [Route("Admin/Koelvloeistof/Delete/{id}")]
        ...
        // POST: Admin/Koelvloeistof/Delete/5
        [Route("Admin/Koelvloeistof/Delete/{id}")]
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["SuccessMessage"] = $"Koelvloeistof <b>{onderdelenProducten.Artikelnummer}</b> werd verwijderd!";
            return RedirectToAction(nameof(Index));
        }
