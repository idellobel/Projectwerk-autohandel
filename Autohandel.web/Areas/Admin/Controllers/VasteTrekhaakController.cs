...
{
    [Area("Admin")]
    public class VasteTrekhaakController : Controller
    {
        private readonly AutohandelContext _context;

        public VasteTrekhaakController(AutohandelContext context)
        {
            _context = context;
        }

        // GET: Admin/VasteTrekhaak
        [Route("Admin/VasteTrekhaak/Index")]
        public async Task<IActionResult> Index()
        {
            var autohandelContext = _context.OnderdelenProducten
                                    ...
                                    .Where(o => o.CategorieOnderdelen.OnderdelenCategorienaam == "Vaste Trekhaak")
        ...
        // GET: Admin/VasteTrekhaak/Details/5
        [Route("Admin/VasteTrekhaak/Details/{id}")]
        ...
        // GET: Admin/VasteTrekhaak/Create
        [Route("Admin/VasteTrekhaak/Create")]
        public IActionResult Create()
        {
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Vaste Trekhaak"), "OnderdelenCategorieId", "OnderdelenCategorienaam");
        ...
        [Route("Admin/VasteTrekhaak/Create")]
        // POST: Admin/VasteTrekhaak/Create
        ...
        public async Task<IActionResult> Create([Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenCreate)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"De vaste trekhaak <b>{onderdelenProductenCreate.Artikelnummer}</b> werd toegevoegd!";
                return RedirectToAction(nameof(Index));
            }
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Vaste Trekhaak"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenCreate.OnderdelenCategorieId);
        ...
        // GET: Admin/VasteTrekhaak/Edit/5
        [Route("Admin/VasteTrekhaak/Edit/{id}")]
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Vaste Trekhaak"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProducten.OnderdelenCategorieId);
        ...
        [Route("Admin/VasteTrekhaak/Edit/{id}")]
        // POST: Admin/VasteTrekhaak/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenEdit)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["SuccessMessage"] = $"De vaste trekhaak <b>{onderdelenProductenEdit.Artikelnummer}</b> werd gewijzigd!";
                    return RedirectToAction(nameof(Index));
                }
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Vaste Trekhaak"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenEdit.OnderdelenCategorieId);
        ...
        // GET: Admin/VasteTrekhaak/Delete/5
        [Route("Admin/VasteTrekhaak/Delete/{id}")]
        ...
        // POST: Admin/VasteTrekhaak/Delete/5
        [Route("Admin/VasteTrekhaak/Delete/{id}")]
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["SuccessMessage"] = $"De vaste trekhaak <b>{onderdelenProducten.Artikelnummer}</b> werd verwijderd!";
            return RedirectToAction(nameof(Index));
        }
