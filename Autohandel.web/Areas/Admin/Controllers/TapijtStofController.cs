...
{
    [Area("Admin")]
    public class TapijtStofController : Controller
    {
        private readonly AutohandelContext _context;

        public TapijtStofController(AutohandelContext context)
        {
            _context = context;
        }

        // GET: Admin/TapijtStof
        [Route("Admin/TapijtStof/Index")]
        public async Task<IActionResult> Index()
        {
            var autohandelContext = _context.OnderdelenProducten
                                   ...
                                   .Where(o => o.CategorieOnderdelen.OnderdelenCategorienaam == "Tapijt Stof")
        ...
        // GET: Admin/TapijtStof/Details/5
        [Route("Admin/TapijtStof/Details/{id}")]
        ...
        // GET: Admin/TapijtStof/Create
        [Route("Admin/TapijtStof/Create")]
        public IActionResult Create()
        {
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Tapijt Stof"), "OnderdelenCategorieId", "OnderdelenCategorienaam");
        ...
        public async Task<IActionResult> Create([Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenCreate)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"Het tapijt in stof <b>{onderdelenProductenCreate.Artikelnummer}</b> werd toegevoegd!";
                return RedirectToAction(nameof(Index));
            }
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Tapijt Stof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenCreate.OnderdelenCategorieId);
        ...
        // GET: Admin/TapijtStof/Edit/5
        [Route("Admin/TapijtStof/Edit/{id}")]
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Tapijt Stof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProducten.OnderdelenCategorieId);
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenEdit)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["SuccessMessage"] = $"Het tapijt in stof <b>{onderdelenProductenEdit.Artikelnummer}</b> werd gewijzigd!";
                    return RedirectToAction(nameof(Index));
                }
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Tapijt Stof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenEdit.OnderdelenCategorieId);
        ...
        // GET: Admin/TapijtStof/Delete/5
        [Route("Admin/TapijtStof/Delete/{id}")]
        ...
        // POST: Admin/TapijtStof/Delete/5
        [Route("Admin/TapijtStof/Delete/{id}")]
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["SuccessMessage"] = $"Het tapijt in stof <b>{onderdelenProducten.Artikelnummer}</b> werd verwijderd!";
            return RedirectToAction(nameof(Index));
        }
