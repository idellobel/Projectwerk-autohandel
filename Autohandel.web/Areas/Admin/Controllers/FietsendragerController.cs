...
{
    [Area("Admin")]
    public class FietsendragerController : Controller
    {
        ...
        // GET: Admin/Fietsendrager
        [Route("Admin/Fietsendrager/Index")]
        public async Task<IActionResult> Index()
        {
            var autohandelContext = _context.OnderdelenProducten
                                   ...
                                   .Where(o => o.CategorieOnderdelen.OnderdelenCategorienaam == "Fietsendrager")
        ...
        // GET: Admin/Fietsendrager/Details/5
        [Route("Admin/Fietsendrager/Details/{id}")]
        ...
        // GET: Admin/Fietsendrager/Create
        [Route("Admin/Fietsendrager/Create")]
        public IActionResult Create()
        {
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Fietsendrager"), "OnderdelenCategorieId", "OnderdelenCategorienaam");
            ViewData["LeveranciersLijst"] = new SelectList(_context.Leveranciers, "LeverancierID", "LeverancierNaam");

            return View();
        }

        // POST: Admin/Fietsendrager/Create
        [Route("Admin/Fietsendrager/Create")]
        ...
        public async Task<IActionResult> Create([Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenCreate)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"De fietsendrager <b>{onderdelenProductenCreate.Artikelnummer}</b> werd toegevoegd!";
                return RedirectToAction(nameof(Index));
            }
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Fietsendrager"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenCreate.OnderdelenCategorieId);
        ...
        // GET: Admin/Fietsendrager/Edit/5
        [Route("Admin/Fietsendrager/Edit/{id}")]
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Fietsendrager"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProducten.OnderdelenCategorieId);
        ...
        // POST: Admin/Fietsendrager/Edit/5
        [Route("Admin/Fietsendrager/Edit/{id}")]
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenEdit)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["SuccessMessage"] = $"De fietsendrager <b>{onderdelenProductenEdit.Artikelnummer}</b> werd gewijzigd!";
                    return RedirectToAction(nameof(Index));
                }
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Fietsendrager"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenEdit.OnderdelenCategorieId);
        ...
        // GET: Admin/Fietsendrager/Delete/5
        ...
        // POST: Admin/Fietsendrager/Delete/5
        [Route("Admin/Voertuigen/Delete/{id}")]
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["SuccessMessage"] = $"De fietsendrager <b>{onderdelenProducten.Artikelnummer}</b> werd verwijderd!";
            return RedirectToAction(nameof(Index));
        }
