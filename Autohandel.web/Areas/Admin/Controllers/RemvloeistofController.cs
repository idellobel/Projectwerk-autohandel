...
{
    [Area("Admin")]
    public class RemvloeistofController : Controller
    {
        ...
        // GET: Admin/Remvloeistof
        [Route("Admin/Remvloeistof/Index")]
        public async Task<IActionResult> Index()
        {
            var autohandelContext = _context.OnderdelenProducten
                                     ...
                                     .Where(o => o.CategorieOnderdelen.OnderdelenCategorienaam == "Remvloeistof")
        ...
        // GET: Admin/Remvloeistof/Details/5
        [Route("Admin/Remvloeistof/Details/{id}")]
        ...
        // GET: Admin/Remvloeistof/Create
        [Route("Admin/Remvloeistof/Create")]
        public IActionResult Create()
        {
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Remvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam");
            ViewData["LeveranciersLijst"] = new SelectList(_context.Leveranciers, "LeverancierID", "LeverancierNaam");

            return View();
        }

        // POST: Admin/Remvloeistof/Create
        [Route("Admin/Remvloeistof/Create")]
        ...
        public async Task<IActionResult> Create([Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenCreate)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"Remvloeistof <b>{onderdelenProductenCreate.Artikelnummer}</b> werd toegevoegd!";
                return RedirectToAction(nameof(Index));
            }
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Remvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenCreate.OnderdelenCategorieId);
        ...
        // GET: Admin/Remvloeistof/Edit/5
        [Route("Admin/Remvloeistof/Edit/{id}")]
        public async Task<IActionResult> Edit(string id)
        {
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Remvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProducten.OnderdelenCategorieId);
        ...
        // POST: Admin/Remvloeistof/Edit/5
        [Route("Admin/Remvloeistof/Edit/{id}")]
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        ...
        public async Task<IActionResult> Edit(string id, [Bind("Leverancier,LeverancierID,Artikelnummer,Artikelnaam,Artikelomschrijving,Prijs,FiguurURL,OpVoorraad,Specificatie,SpecificatieId,CategorieOnderdelen,OnderdelenCategorieId")] OnderdelenProducten onderdelenProductenEdit)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["SuccessMessage"] = $"Remvloeistof <b>{onderdelenProductenEdit.Artikelnummer}</b> werd gewijzigd!";
                    return RedirectToAction(nameof(Index));
                }
            ...
            ViewData["OnderdelenCategorieId"] = new SelectList(_context.CategorieOnderdelen.Where(o => o.OnderdelenCategorienaam == "Remvloeistof"), "OnderdelenCategorieId", "OnderdelenCategorienaam", onderdelenProductenEdit.OnderdelenCategorieId);
        ...
        // GET: Admin/Remvloeistof/Delete/5
        [Route("Admin/Remvloeistof/Delete/{id}")]
        ...
        // POST: Admin/Remvloeistof/Delete/5
        [Route("Admin/Remvloeistof/Delete/{id}")]
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["SuccessMessage"] = $"Remvloeistof <b>{onderdelenProducten.Artikelnummer}</b> werd verwijderd!";
            return RedirectToAction(nameof(Index));
        }
