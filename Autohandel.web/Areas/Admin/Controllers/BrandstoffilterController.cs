...
namespace Autohandel.web.Areas.Admin.Controllers
{
    ...
    public class BrandstoffilterController : Controller
    {
        ...
        [Route("Admin/Brandstoffilter/Index")]
        ...
        [Route("Admin/Brandstoffilter/Details/{id}")]
        ...
        [Route("Admin/Brandstoffilter/Create")]
        ...
        [Route("Admin/Brandstoffilter/Edit/{id}")]
        ...
        [Route("Admin/Brandstoffilter/Delete/{id}")]
