    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoertuigCategoriën", x => x.VoertuigCatId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MerkTypeId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    MerkTypeNaam = table.Column<string>(maxLength: 150, nullable: false),
                    VoertuigMerkMerkId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Types", x => x.MerkTypeId);
                    table.ForeignKey(
                        name: "FK_Types_Merken_VoertuigMerkMerkId",
                        column: x => x.VoertuigMerkMerkId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OnderdelenProducten_Specificaties_SpecificatieId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Chassisnummer = table.Column<long>(nullable: false),
                    Deuren = table.Column<int>(nullable: false),
                    FaktuurNr = table.Column<long>(nullable: false),
                    FiguurURL = table.Column<string>(maxLength: 512, nullable: true),
                    GarantieId = table.Column<long>(nullable: true),
                    GrantieId = table.Column<long>(nullable: false),
                    ...
                    MerkTypeId = table.Column<long>(nullable: false),
                    Prijs = table.Column<decimal>(nullable: false),
                    Registratie = table.Column<string>(nullable: true),
                    Vermogen = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Voertuigen_VoertuigCategoriën_VoertuigCatId",
                        column: x => x.VoertuigCatId,
                        principalTable: "VoertuigCategoriën",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Types_VoertuigMerkMerkId",
                table: "Types",
                column: "VoertuigMerkMerkId");
