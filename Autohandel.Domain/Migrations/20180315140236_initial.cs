        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COTwee = table.Column<string>(nullable: true),
                    ...
                    GarantieTijd = table.Column<string>(nullable: true),
                    ...
                    MerkId = table.Column<long>(nullable: true),
                    MerkTypeId = table.Column<long>(nullable: true),
                    Prijs = table.Column<decimal>(nullable: false),
                    Registratie = table.Column<string>(nullable: true),
                    Vermogen = table.Column<string>(nullable: true),
                    Versnelling = table.Column<int>(nullable: false),
                    VoertuigArtikelNummer = table.Column<string>(nullable: false),
                    VoertuigCategorieVoertuigCatId = table.Column<long>(nullable: true),
                    VoertuigTitel = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Voertuigen_VoertuigCategorieen_VoertuigCategorieVoertuigCatId",
                        column: x => x.VoertuigCategorieVoertuigCatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Voertuigen_VoertuigCategorieVoertuigCatId",
                table: "Voertuigen",
                column: "VoertuigCategorieVoertuigCatId");
        }
