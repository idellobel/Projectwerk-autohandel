...
namespace Autohandel.Domain.Migrations
{
    ...
    [Migration("20180516181641_OrderDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Autohandel.Domain.Entities.Order", b =>
                {
            ...
            modelBuilder.Entity("Autohandel.Domain.Entities.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("Autohandel.Domain.Entities.WinkelkarItem", b =>
                {
                    b.Property<int>("WinkelkarItemId")
                        .ValueGeneratedOnAdd();

                    b.Property<int>("Aantal");

                    b.Property<string>("ProductArtikelnummer");

                    b.Property<string>("WinkelkarId");

                    b.HasKey("WinkelkarItemId");

                    b.HasIndex("ProductArtikelnummer");

                    b.ToTable("WinkelkarItems");
                });
            ...
            modelBuilder.Entity("Autohandel.Domain.Entities.OrderDetail", b =>
                {
                    b.HasOne("Autohandel.Domain.Entities.OnderdelenProducten", "Product")
                        .WithMany()
                        .HasForeignKey("ArtikelNummer");
                    ...
                    b.HasOne("Autohandel.Domain.Entities.Order", "Order")
            ...
            modelBuilder.Entity("Autohandel.Domain.Entities.WinkelkarItem", b =>
                {
                    b.HasOne("Autohandel.Domain.Entities.OnderdelenProducten", "Product")
                        .WithMany()
                        .HasForeignKey("ProductArtikelnummer");
                });
